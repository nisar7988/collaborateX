  ...
  return (
    ...
    <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:flex-row-reverse lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
            ...
            <div className="flex items-center mt-6 gap-x-3">
                <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                    ...
                    <span onClick={()=>navigate(-1)}><a href="javascript:history.back()">Go Back</a></span>
                </button>
        ...
        <div className="relative w-full mt-8 lg:w-1/2 lg:mt-0">
            <img className=" w-full lg:h-[32rem] h-80 md:h-96 rounded-lg object-cover " src={logo} alt="" />
        </div>
    </div>
</section>
    </div>
